...
inline bool stream_line_reader::getline() {
  ...
  size_t i = 0;
  for (;; i++) {
    // std::cout << "stream_line_reader::getline: " << i << std::endl;
    char byte;
  ...
  // std::cout << "stream_line_reader::getline: " << i << std::endl;
  // spdlog::get("logger")->info("stream_line_reader::getline: {}", i);
...
inline socket_t create_client_socket(
  ...
  auto sock = create_socket(
      ...
      [&](socket_t sock2, struct addrinfo &ai) -> bool {
        ...
        // std::cout << "create_client_socket: connection_timeout_sec:" << connection_timeout_sec << std::endl; 
        ...
        // std::cout << "create_client_socket: read_timeout_sec:" << read_timeout_sec << std::endl; 
        // std::cout << "create_client_socket: write_timeout_sec:" << write_timeout_sec << std::endl; 
        // std::cout << "create_client_socket: sock2:" << sock2 << std::endl; 
        // spdlog::get("logger")->info("create_client_socket: sock2:{}", sock2);
...
inline bool read_headers(Stream &strm, Headers &headers) {
  ...
  // spdlog::get("logger")->info("read_headers...");
...
inline bool read_content_with_length(Stream &strm, uint64_t len,
  ...
  uint64_t r = 0;
  while (r < len) {
    // std::cout << "read_content_with_length: " << r << "  " << len<< std::endl;
  ...
  // std::cout << "read_content_with_length: " << r << "  " << len<< std::endl;
  // spdlog::get("logger")->info("read_content_with_length: {}  {}", r, len);
...
inline bool read_content_without_length(Stream &strm,
  ...
  uint64_t r = 0;
  for (;;) {
    // std::cout << "read_content_without_length: " << r << std::endl;
    // spdlog::get("logger")->info("read_content_without_length: {}", r);
...
inline bool write_data(Stream &strm, const char *d, size_t l) {
  ...
  // spdlog::get("logger")->info("write_data l: {}", l);

  while (offset < l) {
    auto length = strm.write(d + offset, l - offset);
    // std::cout << "offset: " << offset  << " length:" << length << std::endl;
    // spdlog::get("logger")->info("write_data offset: {} length: {}", offset, length);
...
inline bool SocketStream::is_writable() const {
  // std::cout << "write_timeout_sec_: " << write_timeout_sec_ << "  usec_: " << write_timeout_usec_ << std::endl;
...
inline ssize_t SocketStream::read(char *ptr, size_t size) {
...
#endif
  // std::cout << "read_buff_off_: " << read_buff_off_ << "  read_buff_content_size_: " << read_buff_content_size_ << std::endl;
  ...
  if (!is_readable()) { 
    // std::cout << "SocketStream::read !is_readable..." << std::endl;
    // spdlog::get("logger")->info("SocketStream::read !is_readable...");
    return -1; 
  }
  // std::cout << "SocketStream::read..." << std::endl;
  // spdlog::get("logger")->info("SocketStream::read...");
...
inline ssize_t SocketStream::write(const char *ptr, size_t size) {
  ...
  size =
      (std::min)(size, static_cast<size_t>((std::numeric_limits<int>::max)()));
#endif
  // std::cout << "SocketStream::write" << std::endl;
  // spdlog::get("logger")->info("SocketStream::write...");
...
inline bool ClientImpl::read_response_line(Stream &strm, const Request &req,
                                           Response &res) {
  std::array<char, 2048> buf{};
  // std::cout << "read_response_line..." << std::endl;
  // spdlog::get("logger")->info("read_response_line...");
...
inline bool ClientImpl::send(Request &req, Response &res, Error &error) {
...

  {
    ...
    auto is_alive = false;
    if (socket_.is_open()) {
      // std::cout << "select_write..." << std::endl;
      // spdlog::get("logger")->info("select_write...");
      is_alive = detail::select_write(socket_.sock, write_timeout_sec_, write_timeout_usec_) > 0;
      if (!is_alive) {
  ...
  // spdlog::get("logger")->info("handle_request...");
...
inline bool ClientImpl::handle_request(Stream &strm, Request &req,
  ...
  if (!is_ssl() && !proxy_host_.empty() && proxy_port_ != -1) {
    ...
    // spdlog::get("logger")->info("process_request...");
...
inline bool ClientImpl::process_request(Stream &strm, Request &req,
  ...
  // std::cout << "write_request ok..." << std::endl;
  // spdlog::get("logger")->info("write_request ok...");
  ...
  // std::cout << "read_response_line ok..." << std::endl;
  // spdlog::get("logger")->info("read_response_line ok...");
  ...
  // std::cout << "read_content ok..." << std::endl;
  // spdlog::get("logger")->info("read_content ok...");
